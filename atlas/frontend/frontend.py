...
class BitsFrontend(SignalFrontend):
    ...
    def __radd__(self, other): return BinaryOp(other, self, 'add', '+')
    def __rsub__(self, other): return BinaryOp(other, self, 'sub', '-')
    def __rmul__(self, other): return BinaryOp(other, self, 'mul', '*')
    def __rdiv__(self, other): return BinaryOp(other, self, 'div', '/')
    def __ror__(self, other): return BinaryOp(other, self, 'or', '|')
    def __rxor__(self, other): return BinaryOp(other, self, 'xor', '^')
    def __rand__(self, other): return BinaryOp(other, self, 'and', '&')
